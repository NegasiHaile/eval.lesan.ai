...
function WaveformSide({
  ...
  return (
    <div
      className={`flex flex-1 items-center gap-[2px] sm:gap-[3px] h-12 sm:h-14 min-w-0 ${
...
export default function ReferenceVoiceArea({
  ...
  return (
    <div className="flex items-center justify-center gap-4 sm:gap-6 w-full max-w-xl mx-auto py-1">
      ...
      {!inCaptureMode ? (
        <button
          ...
          className="relative shrink-0 size-14 sm:size-16 rounded-full bg-white dark:bg-neutral-900 text-red-500 shadow-[0_4px_20px_rgba(0,0,0,0.12)] ring-1 ring-neutral-200/80 dark:ring-neutral-700 transition hover:shadow-[0_6px_24px_rgba(0,0,0,0.16)] disabled:cursor-not-allowed disabled:opacity-60"
        ...
        <button
          ...
          className={`relative shrink-0 size-14 sm:size-16 rounded-full transition shadow-[0_0_0_8px_rgba(244,63,94,0.2)] disabled:cursor-not-allowed ${
            isLastTask
